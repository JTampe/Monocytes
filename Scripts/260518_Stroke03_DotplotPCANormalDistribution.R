...
createFolder("Normal Distribution")

# FACS data
qqnorm(FACSdata$Monocytes)
qqline(FACSdata$Monocytes, col = "red") # Adds a reference line

hist(FACSdata$Monocytes, probability = TRUE)
lines(density(FACSdata$Monocytes), col = "blue") # Adds density curve

qqnorm(FACSdata$Classical_Monocytes)
qqline(FACSdata$Classical_Monocytes, col = "red") # Adds a reference line

hist(FACSdata$Classical_Monocytes, probability = TRUE)
lines(density(FACSdata$Classical_Monocytes), col = "blue") # Adds density curve

qqnorm(FACSdata$Intermediate_Monocytes)
qqline(FACSdata$Intermediate_Monocytes, col = "red") # Adds a reference line

hist(FACSdata$Intermediate_Monocytes, probability = TRUE)
lines(density(FACSdata$Intermediate_Monocytes), col = "blue") # Adds density curve

qqnorm(FACSdata$NonClassical_Monocytes)
qqline(FACSdata$NonClassical_Monocytes, col = "red") # Adds a reference line

hist(FACSdata$NonClassical_Monocytes, probability = TRUE)
lines(density(FACSdata$NonClassical_Monocytes), col = "blue") # Adds density curve

# Gene Expression data
qqnorm(dataFINALmean$mean_capZ)
qqline(dataFINALmean$mean_capZ, col = "red") # Adds a reference line

hist(dataFINALmean$mean_capZ, probability = TRUE)
lines(density(dataFINALmean$mean_capZ), col = "blue") # Adds density curve
